    ...
    <style>
        ...
        * {
        ...
        .btn {
            ...
            font-family: 'Poppins', sans-serif;
            min-height: 48px; /* Untuk aksesibilitas di mobile */
        }
...
<body>
    ...
    <div class="container">
        ...
        <h1 class="main-title">Halaman Tidak Ditemukan</h1>
        ...
        <div class="tips">
            ...
            <ul>
                ...
                <li>Gunakan menu navigasi untuk menemukan halaman yang dicari</li>
    ...
    <script>
        ...
        function createParticles() {
            ...
            const particleCount = 300; // Dikurangi untuk performa
            const colors = ["#a8edea", "#fed6e3", "#667eea", "#ffffff"];

            for (let i = 0; i < particleCount; i++) {
                const particle = document.createElement('div');
                particle.classList.add('particle');

                const size = Math.random() * 10 + 3; // Ukuran lebih kecil
                ...
                particle.style.opacity = Math.random() * 0.4 + 0.1; // Opacity lebih rendah
        ...
        document.body.addEventListener('touchmove', function(e) {
            // Biarkan scroll hanya di dalam container
