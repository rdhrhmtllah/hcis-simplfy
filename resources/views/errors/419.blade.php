...
<body>
    ...
    <div class="container">
        ...
        <h1 class="main-title">Sesi Telah Berakhir</h1>

        <p class="description">
            Sesi Anda telah kedaluwarsa karena tidak ada aktivitas dalam waktu yang lama.
            Untuk keamanan, Anda perlu login kembali.
        </p>
        ...
        <div class="loading-container">
            ...
            <div class="loading-text">Menuju halaman login...</div>
        </div>
        <span class="info-value d-none" id="expiryTime"></span>

        <!-- Session Info -->
        {{-- <div class="session-info">
            <div class="info-item">
                <span class="info-label">Status Sesi:</span>
                <span class="info-value info-badge info-warning">EXPIRED</span>
            </div>
            <div class="info-item">
                <span class="info-label">Waktu Kedaluwarsa:</span>
                <span class="info-value" id="expiryTime"></span>
            </div>
            <div class="info-item">
                <span class="info-label">Sesi ID:</span>
                <span class="info-value" id="sessionId">#{{ rand(1000, 9999) }}</span>
            </div>
        </div> --}}
        ...
        <!-- Tips -->
        {{-- <div class="tips">
            <h3><i class="bi bi-lightbulb"></i> Tips untuk sesi berikutnya:</h3>
            <ul>
                <li>Hindari meninggalkan halaman terbuka terlalu lama</li>
                <li>Simpan pekerjaan secara berkala</li>
                <li>Gunakan browser yang mendukung cookie dengan baik</li>
            </ul>
        </div> --}}
    </div>
    ...
    <script>
        ...
        function createParticles() {
            ...
            const colors = ["#f59e0b", "#fbbf24", "#667eea", "#ffffff"];
        ...
        // document.getElementById('expiryTime').textContent = new Date().toLocaleString('id-ID');
        ...
        // Generate random session ID (simulasi)
